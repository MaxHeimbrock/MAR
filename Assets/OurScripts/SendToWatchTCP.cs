...
public class SendToWatchTCP : MonoBehaviour
{    
    public string host = "192.168.178.57";
    public string port = "52431";
    ...
    private void ConnectUnity(string host, string port)
    {
        ...
        try
        {
            ...
            RestartExchange();
            successStatus = "Connected!";
            Debug.Log("connected in TCP script");
        }
        catch (Exception e)
        {
            errorStatus = e.ToString();
            Debug.LogError("Apple Watch App nicht bereit - TCP-Verbindung nicht angenommen");
        }
#endif
    }
